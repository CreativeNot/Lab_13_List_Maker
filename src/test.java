...
public class test {
        ...
        do {
            ...
            switch (ans) {
                ...
                case "V":
                    ...
                    break;
                case "Q":
                    if (SafeInput.getYNConfirm(in, "Are you sure? You may loose data:")) {
                        if (needsToBeSaved) {
                            saveCurrentFile(arrList, fileName);
                        }
                        run = false;
    ...
    public static void deleteFromList(Scanner in, ArrayList arrList) {
        ...
        System.out.println(itemToDelete + " was successfully deleted!");
    }
    ...
    private static String openListFile(Scanner in, ArrayList arrList, boolean needsToBeSaved) {
        if (needsToBeSaved) {
            String prompt = "Opening a new list will result in losing your current one. Are you sure? [Y/N]";
